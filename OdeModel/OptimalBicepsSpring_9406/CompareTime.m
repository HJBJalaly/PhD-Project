function CompareTime(Coef_X0,Coef_Opt,Time,Degree,Mode)
...
%%%% Initial
Coef_X0_Q1=Coef_X0(1:(rQ+1));
Coef_X0_Q2=Coef_X0((rQ+1)+1:2*(rQ+1));
Coef_X0_Q3=Coef_X0(2*(rQ+1)+1:3*(rQ+1));
Coef_X0_D1Q1=Coef_X0_Q1(1:end-1).*(rQ:-1:1);
Coef_X0_D1Q2=Coef_X0_Q2(1:end-1).*(rQ:-1:1);
Coef_X0_D1Q3=Coef_X0_Q3(1:end-1).*(rQ:-1:1);
Coef_X0_D2Q1=Coef_X0_D1Q1(1:end-1).*(rQ-1:-1:1);
Coef_X0_D2Q2=Coef_X0_D1Q2(1:end-1).*(rQ-1:-1:1);
Coef_X0_D2Q3=Coef_X0_D1Q3(1:end-1).*(rQ-1:-1:1);

Q1_X0=polyval(Coef_X0_Q1,Time);
    Q1_X0=InRangeShifter(Q1_X0);
Q2_X0=polyval(Coef_X0_Q2,Time);
    Q2_X0=InRangeShifter(Q2_X0);
Q3_X0=polyval(Coef_X0_Q3,Time);
    Q3_X0=InRangeShifter(Q3_X0);
D1Q1_X0=polyval(Coef_X0_D1Q1,Time);
D1Q2_X0=polyval(Coef_X0_D1Q2,Time);
D1Q3_X0=polyval(Coef_X0_D1Q3,Time);
D2Q1_X0=polyval(Coef_X0_D2Q1,Time);
D2Q2_X0=polyval(Coef_X0_D2Q2,Time);
D2Q3_X0=polyval(Coef_X0_D2Q3,Time);

QVal_X0=[Q1_X0;Q2_X0;Q3_X0];
