function [TorqueDesire,TorqueActive,Qq,D1Qq,D2Qq,BetaOptimal,ThetaOptimal, IntU2,IntUdq,IntAbsUdq,IntAbsUdqDesire,CostSlopeD1Q,CostSlopeD2Q,CostParamReg ,RMS]=...
    ...
    elseif(strcmp(Mode,'CostCc'))
        ...
        figure('name',['Torque vs Angle : ',Name])
                ...
                if(rB>0)
                    ...
                    hold off
                    legend('2\times u_b_1','u_r_1+u_r_2-u_b_1-u_b_2-u_b_2','Orientation','horizontal')
                    set(gca,'FontWeight','bold','FontSize',12,'FontName','mwa_cmb10');
                    ...
                    hold off
                    legend('2\times u_b_2','u_r_2+u_r_3-u_b_2-u_b_3-u_b_1','Orientation','horizontal')
                    set(gca,'FontWeight','bold','FontSize',12,'FontName','mwa_cmb10');
