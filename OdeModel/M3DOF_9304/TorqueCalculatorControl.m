function status=TorqueCalculatorControl(t,Y,flag,g,L,m,Qref,DQref,Time,Kp,Kd,PassiveParam,rU)
...
Torque= [Torque,[Kp*([Q1ref Q2ref Q3ref]'-[q1 q2 q3]')+Kd*([DQ1ref DQ2ref DQ3ref]'-D1Q); TorquePassive]];
