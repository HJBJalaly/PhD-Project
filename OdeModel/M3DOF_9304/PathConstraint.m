function [Cneq,Ceq]=PathConstraint(Alpha,Time,Tres,Degree,L,Xef,Yef,g,mL1,mL2,mL3,LL1,LL2,LL3,Q_limit,DQ_limit,SampleRate)
...
Cneq=[sum(sum((RPos-Pos).^2))*Tres*20-.00000005;
     ...
     -(Q2(1:SampleRate:end))'+Q_limit(2,1);
      (Q3(1:SampleRate:end))'-Q_limit(3,2);
     -(Q3(1:SampleRate:end))'+Q_limit(3,1);
