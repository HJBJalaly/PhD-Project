...
Result=sprintf('% 11.2f  % 11.2f % 15.2f'  ,   Cost*Tres,WorkDesire,WorkActuator);
disp('-------------------------------------------------------')
disp(Title)
disp(Result)
...
[TorqueDesire_X0,TorqueActive_X0,Q_X0,D1Q_X0,D2Q_X0,BetaOptimal_X0,IntU2_X0,IntUdq_X0,IntAbsUdq_X0,IntAbsUdqDesire_X0,CostSlopeD1Q_X0,CostSlopeD2Q_X0,RMSError_X0]=...    
                        ShowTime(Initial,Time,Tres,Degree,Weight,Landa,[],[],[] ,XEF,YEF,m,L,g,[],'DntShow','2Cycle','CostCc','Initial');
