function AnimBotMultimotuin4DOF(T,Y,XY,L,d0)
...
%         
        ...
        for i=1:length(T)-1
            ...
            Link1UpPos=[XY(MotionNo,1)+(Y(i,1)+d0)*sin(Y(i,2))     , XY(MotionNo,2)-(Y(i,1)+d0)*cos(Y(i,2))];
            Link1DnPos=[XY(MotionNo,1)+(Y(i,1)+d0+L)*sin(Y(i,2))   , XY(MotionNo,2)-(Y(i,1)+d0+L)*cos(Y(i,2))];
            ...
            set(S1Hndl,'XData', [XY(MotionNo,1) Link1UpPos(1)], 'YData', [XY(MotionNo,2) Link1UpPos(2)]);
