function [sys,x0]=AnimBot10(t,x,u, flag,ts); 
...
switch flag,
  ...
  case 2, 
    ...
    if any( get(0,'Children') == FigHndl )
      ...
      if strcmp(  get( FigHndl,'Name' ), FigName  )
        ...
        set(S1Hndl,'XData', [0 u( 1)], 'YData', [0 u( 2)]);
        set(L1Hndl,'XData', [u( 1) u( 3)], 'YData', [u( 2) u( 4)]);
        set(L2Hndl,'XData', [u( 5) u(7)], 'YData', [u(6) u(8)]);
        set(S2Hndl,'XData', [u(7) u(9)], 'YData', [u(8) u(10)]);
        set(M4Hndl,'XData', [u(9)], 'YData', [u(10)]);
  ...
  case 9,
    ...
    %Zeit erneut messen
    t2 = now;
    fprintf('\nsimulation time: %s',datestr(t2-t1, 13));
